...
unsigned Menu::GetFieldWidth() {
    return fieldWidth;
}

unsigned Menu::GetFieldHeight() {
    return fieldHeight;
}

unsigned Menu::GetUserResolutionWidth() {
    return userResolutionWidth;
}

unsigned Menu::GetUserResolutionHeight() {
    return userResolutionHeight;
}
